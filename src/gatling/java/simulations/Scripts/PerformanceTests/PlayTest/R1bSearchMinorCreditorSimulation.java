...
public class R1bSearchMinorCreditorSimulation extends Simulation {
    ...
    public void before() {
        ...
        System.out.println("User Count: " + AppConfig.PerformanceConfig.MINOR_CREDITOR_USERS);
    ...
    public R1bSearchMinorCreditorSimulation() {
        setUp(
            R1bMinorCreditorSearchBuild.build(SCENARIO_NAME)
                .injectOpen(
