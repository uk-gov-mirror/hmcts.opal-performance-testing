...
public final class CreateAccountFineMinorCreditScenario {

    private CreateAccountFineMinorCreditScenario() {}

    public static ChainBuilder CreateAccountMinorCreditRequest() {
                    ...
                    exec(session -> {
                        try {
                            String draftAccountRequestPayload =
                                RequestBodyBuilder.BuildDraftAccountMinorCreditorRequestBody(session);
